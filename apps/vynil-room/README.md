...
add `http://127.0.0.1:5173/vynil-room/` as a Redirect URI on the app, and put the
...
Open the app at **http://127.0.0.1:5173/vynil-room/** — not `localhost`, since
Spotify's redirect URI matching requires the exact host you registered. This
app is one of several under the [aislop.codes](../../README.md) monorepo, served
at the `/vynil-room` subpath rather than a domain's root — that's why the URL
needs the trailing path even locally.
